  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <b>巧破</b>：当你受到 1 点伤害时，你可以交给一名其他角色一张方块牌并此伤害转移给该角色。 
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        ...
        <b>奇风</b>：当你对其他角色造成非此技能转移的伤害时，你可以令另一名角色选择一项：1. 弃置一张红桃手牌。2. 将此伤害转移给该角色，然后其摸 X 张牌，X 为该角色已损失的体力值。
      </td>
    </tr>
  </tbody>
</table>
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td>
        <b>断雁</b>：其他角色的出牌阶段开始时，你可以交给其一张方块牌，该角色受到你造成的 1 点伤害，若该角色为男性，其摸 X 张牌，X 为该角色与你距离的一半（向下取整）。<br>
